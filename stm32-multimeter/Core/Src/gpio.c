...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CON_100K_Pin|CON_1K_Pin|CON_100R_Pin|CON_10K_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, RES_VOL_CON_Pin|BLACK_CON_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CON_100K_Pin|CON_1K_Pin|CON_100R_Pin|CON_10K_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = RES_VOL_CON_Pin|BLACK_CON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
{
	HAL_GPIO_WritePin(RES_VOL_CON_GPIO_Port, RES_VOL_CON_Pin, GPIO_PIN_SET);
}
/*
 * 函数内容：继电器连接到电压测量端
 * 函数参数：无
...
{
	HAL_GPIO_WritePin(RES_VOL_CON_GPIO_Port, RES_VOL_CON_Pin, GPIO_PIN_RESET);
}
/*
 * 函数内容：使公共端连通GND
 * 函数参数：无
