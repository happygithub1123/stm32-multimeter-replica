...
#define CON_100R_Pin GPIO_PIN_8
#define CON_100R_GPIO_Port GPIOE
#define CON_1K_Pin GPIO_PIN_10
#define CON_1K_GPIO_Port GPIOE
#define CON_10K_Pin GPIO_PIN_11
#define CON_10K_GPIO_Port GPIOE
#define CUR_CON_Pin GPIO_PIN_12
#define CUR_CON_GPIO_Port GPIOE
#define CON_100K_Pin GPIO_PIN_13
#define CON_100K_GPIO_Port GPIOE
#define RES_CON_Pin GPIO_PIN_14
#define RES_CON_GPIO_Port GPIOE
#define VOL_CON_Pin GPIO_PIN_15
#define VOL_CON_GPIO_Port GPIOE
...
#define BLACK_CON_Pin GPIO_PIN_4
#define BLACK_CON_GPIO_Port GPIOB
...
struct KeyInfo
{
	...
	uint16_t ref_vol_value;	//内部参考电压值，仅在上电时测量校准
};
