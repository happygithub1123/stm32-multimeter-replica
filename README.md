...
- 收录 V1.2 小表笔项目的原理图文档：`原理图/SCH_Schematic1_2_2026-09-17.pdf`。
- 保留原始 `说明文档.md` 与 `LICENSE`。原理图以 PDF 形式提供，当前未收录可编辑的 PCB/原理图设计工程。
...
本次复刻以 **V1.2 小表笔版本**为主要对象。项目基于天空星 STM32F407VET6，制作简易数字万用表拓展板，支持电压、电流、电阻、通断和二极管档测量。
...
项目原理图文档：[SCH_Schematic1_2_2026-09-17.pdf](原理图/SCH_Schematic1_2_2026-09-17.pdf)。下方截图保留原项目的原理介绍，复刻时请结合该 PDF 核对器件、阻值及接线。
...
> **版本名称说明**：本次项目主要针对 V1.2 小表笔硬件；保留的源码目录名为 `stm32-multimeter` 和 `stm32-multimeter-V2.0`。硬件版本与源码目录编号不能仅凭名称直接对应。请结合所附原理图核对实际硬件引脚和固件配置，原说明明确指出两个代码版本不能混用。
...
├── 说明文档.md
├── 原理图/
│   └── SCH_Schematic1_2_2026-09-17.pdf  # 本次复刻的原理图文档
├── docs/images/                 # 原项目截图
